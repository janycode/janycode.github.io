...
### [半角和全角转换](https://www.hutool.cn/docs/#/core/类型转换/类型转换工具类-Convert?id=半角和全角转换)
...
### [`ConverterRegistry`单例和对象模式](https://www.hutool.cn/docs/#/core/类型转换/自定义类型转换-ConverterRegistry?id=converterregistry单例和对象模式)
...
### [格式化时间差](https://www.hutool.cn/docs/#/core/日期时间/日期时间工具-DateUtil?id=格式化时间差)
...
### [新建对象](https://www.hutool.cn/docs/#/core/日期时间/日期时间对象-DateTime?id=新建对象)
...
### [判断是否为null](https://www.hutool.cn/docs/#/core/工具类/对象工具-ObjectUtil?id=判断是否为null)
...
### [`getTypeArgument`](https://www.hutool.cn/docs/#/core/工具类/泛型类型工具-TypeUtil?id=gettypeargument)
...
### [`getShortClassName`](https://www.hutool.cn/docs/#/core/工具类/类工具-ClassUtil?id=getshortclassname)
...
### [`getFieldValues`](https://www.hutool.cn/docs/#/core/工具类/枚举工具-EnumUtil?id=getfieldvalues)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=介绍)
...
### [zip](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=zip)
...
### [是否包含元素](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=是否包含元素)

`ArrayUtil.contains`方法只针对泛型数组，检测指定元素是否在数组中。

### [包装和拆包](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=包装和拆包)

在原始类型元素和包装类型中，Java实现了自动包装和拆包，但是相应的数组无法实现，于是便是用`ArrayUtil.wrap`和`ArrayUtil.unwrap`对原始类型数组和包装类型数组进行转换。

### [判断对象是否为数组](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=判断对象是否为数组)

`ArrayUtil.isArray`方法封装了`obj.getClass().isArray()`。

### [转为字符串](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=转为字符串)
...
### [toArray](https://www.hutool.cn/docs/#/core/工具类/数组工具-ArrayUtil?id=toarray)

`ArrayUtil.toArray`方法针对ByteBuffer转数组提供便利。

# 随机工具-RandomUtil

## [说明](https://www.hutool.cn/docs/#/core/工具类/随机工具-RandomUtil?id=说明)

`RandomUtil`主要针对JDK中`Random`对象做封装，严格来说，Java产生的随机数都是伪随机数，因此Hutool封装后产生的随机结果也是伪随机结果。不过这种随机结果对于大多数情况已经够用。

## [使用](https://www.hutool.cn/docs/#/core/工具类/随机工具-RandomUtil?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/唯一ID工具-IdUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/唯一ID工具-IdUtil?id=使用)

### [UUID](https://www.hutool.cn/docs/#/core/工具类/唯一ID工具-IdUtil?id=uuid)
...
### [ObjectId](https://www.hutool.cn/docs/#/core/工具类/唯一ID工具-IdUtil?id=objectid)
...
### [Snowflake](https://www.hutool.cn/docs/#/core/工具类/唯一ID工具-IdUtil?id=snowflake)
...
## [由来](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=由来)
...
## [方法](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=方法)

### [Zip](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=zip)
...
### [Gzip](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=gzip)

Gzip是网页传输中广泛使用的压缩方式，Hutool同样提供其工具方法简化其过程。

`ZipUtil.gzip` 压缩，可压缩字符串，也可压缩文件 `ZipUtil.unGzip` 解压Gzip文件

### [Zlib](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=zlib)
...
### [常见问题](https://www.hutool.cn/docs/#/core/工具类/压缩工具-ZipUtil?id=常见问题)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/引用工具-ReferenceUtil?id=介绍)
...
## [方法](https://www.hutool.cn/docs/#/core/工具类/引用工具-ReferenceUtil?id=方法)

### [`create`](https://www.hutool.cn/docs/#/core/工具类/引用工具-ReferenceUtil?id=create)

根据类型枚举创建引用。

# 正则工具-ReUtil

## [由来](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=由来)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=使用)

### [ReUtil.extractMulti](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilextractmulti)
...
### [ReUtil.delFirst](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutildelfirst)
...
### [ReUtil.findAll](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilfindall)
...
### [ReUtil.getFirstNumber](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilgetfirstnumber)
...
### [ReUtil.isMatch](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilismatch)
...
### [ReUtil.replaceAll](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilreplaceall)
...
### [ReUtil.escape](https://www.hutool.cn/docs/#/core/工具类/正则工具-ReUtil?id=reutilescape)
...
## [由来](https://www.hutool.cn/docs/#/core/工具类/身份证工具-IdcardUtil?id=由来)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/身份证工具-IdcardUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/身份证工具-IdcardUtil?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/信息脱敏工具-DesensitizedUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/信息脱敏工具-DesensitizedUtil?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/社会信用代码工具-CreditCodeUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/社会信用代码工具-CreditCodeUtil?id=使用)

### [校验](https://www.hutool.cn/docs/#/core/工具类/社会信用代码工具-CreditCodeUtil?id=校验)
...
### [随机社会信用代码](https://www.hutool.cn/docs/#/core/工具类/社会信用代码工具-CreditCodeUtil?id=随机社会信用代码)
...
## [介绍](https://www.hutool.cn/docs/#/core/工具类/SPI加载工具-ServiceLoaderUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/工具类/SPI加载工具-ServiceLoaderUtil?id=使用)
...
## [由来](https://www.hutool.cn/docs/#/core/语言特性/HashMap扩展-Dict?id=由来)
...
## [介绍](https://www.hutool.cn/docs/#/core/语言特性/HashMap扩展-Dict?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/语言特性/HashMap扩展-Dict?id=使用)

### [创建](https://www.hutool.cn/docs/#/core/语言特性/HashMap扩展-Dict?id=创建)
...
### [获取指定类型的值](https://www.hutool.cn/docs/#/core/语言特性/HashMap扩展-Dict?id=获取指定类型的值)
...
## [为什么会有这个类](https://www.hutool.cn/docs/#/core/语言特性/单例工具-Singleton?id=为什么会有这个类)
...
## [使用](https://www.hutool.cn/docs/#/core/语言特性/单例工具-Singleton?id=使用)
...
## [总结](https://www.hutool.cn/docs/#/core/语言特性/单例工具-Singleton?id=总结)
...
## [由来](https://www.hutool.cn/docs/#/core/语言特性/断言-Assert?id=由来)
...
## [介绍](https://www.hutool.cn/docs/#/core/语言特性/断言-Assert?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/语言特性/断言-Assert?id=使用)
...
## [更多方法](https://www.hutool.cn/docs/#/core/语言特性/断言-Assert?id=更多方法)
...
## [介绍](https://www.hutool.cn/docs/#/core/语言特性/二进码十进数-BCD?id=介绍)
...
## [方法](https://www.hutool.cn/docs/#/core/语言特性/二进码十进数-BCD?id=方法)
...
## [由来](https://www.hutool.cn/docs/#/core/语言特性/控制台打印封装-Console?id=由来)
...
## [使用](https://www.hutool.cn/docs/#/core/语言特性/控制台打印封装-Console?id=使用)
...
## [作用](https://www.hutool.cn/docs/#/core/语言特性/字段验证器-Validator?id=作用)

验证给定字符串是否满足指定条件，一般用在表单字段验证里。

此类中全部为静态方法。

## [使用](https://www.hutool.cn/docs/#/core/语言特性/字段验证器-Validator?id=使用)

### [判断验证](https://www.hutool.cn/docs/#/core/语言特性/字段验证器-Validator?id=判断验证)
...
### [异常验证](https://www.hutool.cn/docs/#/core/语言特性/字段验证器-Validator?id=异常验证)
...
## [由来](https://www.hutool.cn/docs/#/core/语言特性/字符串格式化-StrFormatter?id=由来)

我一直对Slf4j的字符串格式化情有独钟，通过`{}`这种简单的占位符完成字符串的格式化。于是参考Slf4j的源码，便有了`StrFormatter`。

> StrFormatter.format的快捷使用方式为`StrUtil.format`，推荐使用后者。

## [使用](https://www.hutool.cn/docs/#/core/语言特性/字符串格式化-StrFormatter?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/语言特性/树结构/树结构工具-TreeUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/语言特性/树结构/树结构工具-TreeUtil?id=使用)

### [定义结构](https://www.hutool.cn/docs/#/core/语言特性/树结构/树结构工具-TreeUtil?id=定义结构)
...
### [构建Tree](https://www.hutool.cn/docs/#/core/语言特性/树结构/树结构工具-TreeUtil?id=构建tree)
...
### [自定义字段名](https://www.hutool.cn/docs/#/core/语言特性/树结构/树结构工具-TreeUtil?id=自定义字段名)
...
## [什么是Bean](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=什么是bean)
...
## [方法](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=方法)

### [是否为Bean对象](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=是否为bean对象)
...
### [内省 Introspector](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=内省-introspector)
...
### [Bean属性注入](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=bean属性注入)
...
### [Bean转为Map](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=bean转为map)
...
### [Bean转Bean](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=bean转bean)
...
### [Alias注解](https://www.hutool.cn/docs/#/core/JavaBean/Bean工具-BeanUtil?id=alias注解)
...
## [介绍](https://www.hutool.cn/docs/#/core/JavaBean/DynaBean?id=介绍)

DynaBean是使用反射机制动态操作JavaBean的一个封装类，通过这个类，可以通过字符串传入name方式动态调用get和set方法，也可以动态创建JavaBean对象，亦或者执行JavaBean中的方法。

## [使用](https://www.hutool.cn/docs/#/core/JavaBean/DynaBean?id=使用)
...
### [创建](https://www.hutool.cn/docs/#/core/JavaBean/DynaBean?id=创建)
...
### [操作](https://www.hutool.cn/docs/#/core/JavaBean/DynaBean?id=操作)
...
### [invoke](https://www.hutool.cn/docs/#/core/JavaBean/DynaBean?id=invoke)
...
## [由来](https://www.hutool.cn/docs/#/core/JavaBean/表达式解析-BeanPath?id=由来)

很多JavaBean嵌套有很多层对象，这其中还夹杂着Map、Collection等对象，因此获取太深的嵌套对象会让代码变得冗长不堪。因此我们可以考虑使用一种表达式还获取指定深度的对象，于是BeanResolver应运而生。

## [原理](https://www.hutool.cn/docs/#/core/JavaBean/表达式解析-BeanPath?id=原理)
...
## [使用](https://www.hutool.cn/docs/#/core/JavaBean/表达式解析-BeanPath?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/JavaBean/Bean描述-BeanDesc?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/JavaBean/Bean描述-BeanDesc?id=使用)
...
### [字段getter方法获取](https://www.hutool.cn/docs/#/core/JavaBean/Bean描述-BeanDesc?id=字段getter方法获取)
...
### [字段属性赋值](https://www.hutool.cn/docs/#/core/JavaBean/Bean描述-BeanDesc?id=字段属性赋值)
...
## [介绍](https://www.hutool.cn/docs/#/core/JavaBean/空检查属性获取-Opt?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/JavaBean/空检查属性获取-Opt?id=使用)
...
## [学习：](https://www.hutool.cn/docs/#/core/JavaBean/空检查属性获取-Opt?id=学习：)
...
## [介绍](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=介绍)

这个工具主要增加了对数组、集合类的操作。

### [`join` 方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=join-方法)
...
### [`sortPageAll`、`sortPageAll2`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=sortpageall、sortpageall2方法)
...
### [`sortEntrySetToList`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=sortentrysettolist方法)

这个方法主要是对`Entry<Long, Long>`按照Value的值做排序，使用局限性较大，我已经忘记哪里用到过了……

### [`popPart`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=poppart方法)

这个方法传入一个栈对象，然后弹出指定数目的元素对象，弹出是指`pop()`方法，会从原栈中删掉。

### [`append`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=append方法)
...
### [7. `resize`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=_7-resize方法)

重新调整数据的大小，如果调整后的大小比原来小，截断，如果比原来大，则多出的位置空着。（貌似List在扩充的时候会用到类似的方法）

### [`addAll`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=addall方法)

将多个数据合并成一个数组

### [`sub`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=sub方法)

对集合切片，其他类型的集合会转换成`List`，封装`List.subList`方法，自动修正越界等问题，完全避免`IndexOutOfBoundsException`异常。

### [`isEmpty`、`isNotEmpty`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=isempty、isnotempty方法)

判断集合是否为空（包括null和没有元素的集合）。

### [`zip`方法](https://www.hutool.cn/docs/#/core/集合类/集合工具-CollUtil?id=zip方法)
...
## [介绍](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=介绍)

List在集合中中使用最为频繁，因此新版本的Hutool中针对`List`单独封装了工具方法。

## [使用](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=使用)

### [过滤列表](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=过滤列表)
...
### [获取满足指定规则所有的元素的位置](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=获取满足指定规则所有的元素的位置)
...
### [拆分](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=拆分)
...
### [编辑元素](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=编辑元素)
...
### [查找位置](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=查找位置)
...
### [列表截取](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=列表截取)
...
### [排序](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=排序)
...
### [元素交换](https://www.hutool.cn/docs/#/core/集合类/列表工具-ListUtil?id=元素交换)
...
## [来源](https://www.hutool.cn/docs/#/core/集合类/Iterator工具-IterUtil?id=来源)

最早此工具类中的方法是在CollUtil中的，由于经过抽象，因此单独拿出来以适应更广的场景。

## [方法介绍](https://www.hutool.cn/docs/#/core/集合类/Iterator工具-IterUtil?id=方法介绍)
...
## [简介](https://www.hutool.cn/docs/#/core/集合类/有界优先队列-BoundedPriorityQueue?id=简介)
...
## [简介](https://www.hutool.cn/docs/#/core/集合类/线程安全的HashSet-ConcurrentHashSet?id=简介)

我们知道，JDK提供了线程安全的HashMap：ConcurrentHashMap，但是没有提供对应的ConcurrentHashSet，Hutool借助ConcurrentHashMap封装了线程安全的ConcurrentHashSet。

## [使用](https://www.hutool.cn/docs/#/core/集合类/线程安全的HashSet-ConcurrentHashSet?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=介绍)

Java8中的新特性之一就是Stream，Hutool针对常用操作做了一些封装

## [使用](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=使用)

### [集合转Map](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=集合转map)
...
### [分组](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=分组)
...
### [转换提取](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=转换提取)
...
### [合并](https://www.hutool.cn/docs/#/core/集合类/集合串行流工具-CollStreamUtil?id=合并)
...
## [介绍](https://www.hutool.cn/docs/#/core/集合类/行遍历器-LineIter?id=介绍)

此工具分别参考和`Apache Commons io`和`Guava`项目。

将Reader包装为一个按照行读取的Iterator。

### [使用](https://www.hutool.cn/docs/#/core/集合类/行遍历器-LineIter?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Map/Map工具-MapUtil?id=介绍)

MapUtil是针对Map的一一列工具方法的封装，包括getXXX的快捷值转换方法。

## [方法](https://www.hutool.cn/docs/#/core/Map/Map工具-MapUtil?id=方法)
...
## [介绍](https://www.hutool.cn/docs/#/core/Map/双向查找Map-BiMap?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/Map/双向查找Map-BiMap?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Map/可重复键值Map-TableMap?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/Map/可重复键值Map-TableMap?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/Base62编码解码-Base62?id=介绍)

Base62编码是由10个数字、26个大写英文字母和26个小写英文字母组成，多用于安全领域和短URL生成。

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/Base62编码解码-Base62?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/Base64编码解码-Base64?id=介绍)

Base64编码是用64（2的6次方）个ASCII字符来表示256（2的8次方）个ASCII字符，也就是三位二进制数组经过编码后变为四位的ASCII字符显示，长度比原来增加1/3。

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/Base64编码解码-Base64?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/Base32编码解码-Base32?id=介绍)

Base32就是用32（2的5次方）个特定ASCII码来表示256个ASCII码。所以，5个ASCII字符经过base32编码后会变为8个字符（公约数为40），长度增加3/5.不足8n用“=”补足。

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/Base32编码解码-Base32?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/莫尔斯电码-Morse?id=介绍)

摩尔斯电码也被称作摩斯密码，是一种时通时断的信号代码，通过不同的排列顺序来表达不同的英文字母、数字和标点符号。

摩尔斯电码是由点dot（.）划dash（-）这两种符号所组成的。

## [实现](https://www.hutool.cn/docs/#/core/Codec编码/莫尔斯电码-Morse?id=实现)

### [编码](https://www.hutool.cn/docs/#/core/Codec编码/莫尔斯电码-Morse?id=编码)
...
### [解码](https://www.hutool.cn/docs/#/core/Codec编码/莫尔斯电码-Morse?id=解码)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/BCD码-BCD?id=介绍)

BCD码（Binary-Coded Decimal‎）亦称二进码十进数或二-十进制代码。

BCD码这种编码形式利用了四个位元来储存一个十进制的数码，使二进制和十进制之间的转换得以快捷的进行。

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/BCD码-BCD?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/回转N位密码-Rot?id=介绍)

RotN（rotate by N places），回转N位密码，是一种简易的替换式密码，也是过去在古罗马开发的凯撒加密的一种变体。

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/回转N位密码-Rot?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/Codec编码/Punycode实现-PunyCode?id=介绍)

Punycode是一个根据RFC 3492标准而制定的编码系统，主要用于把域名从地方语言所采用的Unicode编码转换成为可用于DNS系统的编码。

具体见：[RFC 3492](https://www.ietf.org/rfc/rfc3492.html)

## [使用](https://www.hutool.cn/docs/#/core/Codec编码/Punycode实现-PunyCode?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=使用)

### [读取CSV文件](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=读取csv文件)

#### [读取为CsvRow](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=读取为csvrow)
...
#### [读取为Bean列表](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=读取为bean列表)
...
### [生成CSV文件](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=生成csv文件)
...
### [乱码问题](https://www.hutool.cn/docs/#/core/文本操作/CSV文件处理工具-CsvUtil?id=乱码问题)
...
## [介绍](https://www.hutool.cn/docs/#/core/文本操作/可复用字符串生成器-StrBuilder?id=介绍)

在JDK提供的`StringBuilder`中，拼接字符串变得更加高效和灵活，但是生成新的字符串需要重新构建`StringBuilder`对象，造成性能损耗和内存浪费，因此Hutool提供了可复用的`StrBuilder`。

## [使用](https://www.hutool.cn/docs/#/core/文本操作/可复用字符串生成器-StrBuilder?id=使用)
...
## [多次构建字符串性能测试](https://www.hutool.cn/docs/#/core/文本操作/可复用字符串生成器-StrBuilder?id=多次构建字符串性能测试)
...
## [介绍](https://www.hutool.cn/docs/#/core/文本操作/Unicode编码转换工具-UnicodeUtil?id=介绍)

此工具主要针对类似于`\\u4e2d\\u6587`这类Unicode字符做一些特殊转换。

## [使用](https://www.hutool.cn/docs/#/core/文本操作/Unicode编码转换工具-UnicodeUtil?id=使用)

### [字符串转Unicode符](https://www.hutool.cn/docs/#/core/文本操作/Unicode编码转换工具-UnicodeUtil?id=字符串转unicode符)
...
### [Unicode转字符串](https://www.hutool.cn/docs/#/core/文本操作/Unicode编码转换工具-UnicodeUtil?id=unicode转字符串)
...
## [由来](https://www.hutool.cn/docs/#/core/文本操作/字符串切割-StrSplitter?id=由来)
...
## [方法](https://www.hutool.cn/docs/#/core/文本操作/字符串切割-StrSplitter?id=方法)

### [基础方法](https://www.hutool.cn/docs/#/core/文本操作/字符串切割-StrSplitter?id=基础方法)
...
### [特殊方法](https://www.hutool.cn/docs/#/core/文本操作/字符串切割-StrSplitter?id=特殊方法)

`splitPath` 切分字符串，分隔符为"/" `splitPathToArray` 切分字符串，分隔符为"/"，返回数组。

# 注解工具-AnnotationUtil

## [介绍](https://www.hutool.cn/docs/#/core/注解/注解工具-AnnotationUtil?id=介绍)

封装了注解获取等方法的工具类。

## [使用](https://www.hutool.cn/docs/#/core/注解/注解工具-AnnotationUtil?id=使用)

### [方法介绍](https://www.hutool.cn/docs/#/core/注解/注解工具-AnnotationUtil?id=方法介绍)
...
## [介绍](https://www.hutool.cn/docs/#/core/比较器/比较工具-CompareUtil?id=介绍)
...
## [介绍](https://www.hutool.cn/docs/#/core/比较器/版本比较器-VersionComparator?id=介绍)
...
## [使用](https://www.hutool.cn/docs/#/core/比较器/版本比较器-VersionComparator?id=使用)
...
## [介绍](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=介绍)

针对异常封装，例如包装为`RuntimeException`。

## [方法](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=方法)

### [包装异常](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=包装异常)
...
### [获取入口方法](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=获取入口方法)
...
### [异常转换](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=异常转换)
...
### [其他方法](https://www.hutool.cn/docs/#/core/异常/异常工具-ExceptionUtil?id=其他方法)
...
## [介绍](https://www.hutool.cn/docs/#/core/数学/数学相关-MathUtil?id=介绍)

此工具是NumberUtil的一个补充，NumberUtil偏向于简单数学计算的封装，MathUtil偏向复杂数学计算。

## [方法](https://www.hutool.cn/docs/#/core/数学/数学相关-MathUtil?id=方法)
