...
缺点：控制层代码太多，违背单一职责原则，因此引入三层架构设计。

`Model + View + 三层架构(Controller + Service + Dao)`
● Controller  控制层，只处理请求
● Service  业务层，只处理业务
● Dao  持久层，只处理数据库操作
...
![image-20200530164500359](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/image-20200530164500359.png)
