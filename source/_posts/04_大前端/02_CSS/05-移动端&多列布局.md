...
移动端因分辨率比例兼容，`以下px像素值，均为量取的物理分辨率都需要使用除以 2 后的结果`。
    ...
    <style>
        *{
        ...
        header div:nth-child(1){
            /* 绘制圆角：因高25px，圆角一半即12px，所以 左上12px 右上0 右下0 左下12px */
            border-radius: 12px 0 0 12px;
            background: lightgreen;
        }
        header div:nth-child(2){
            /* 绘制圆角：同理，所以 左上0 右上12px 右下12px 左下0 */
...
![image-20251203085110256](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20251203085118.png)
