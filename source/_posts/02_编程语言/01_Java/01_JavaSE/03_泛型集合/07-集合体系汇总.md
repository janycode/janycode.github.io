...
![Java-Collection体系集合](https://img-blog.csdnimg.cn/20200314213542253.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)
#### 1.1 List 表
List接口
特点：有序、有下标、元素可重复
...
### 2. Map体系集合
![Java-Map体系集合](https://img-blog.csdnimg.cn/202003142152303.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)
特点：
* 用于存储任意键值对（Key-Value）
* 键：无序、无下标、不允许重复（唯一）
* 值：无序、无下标、允许重复
...
### 3. Collecitons 工具类
上图！一图胜千言！
![Java-Collecitons工具类](https://img-blog.csdnimg.cn/20200314220055518.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)
