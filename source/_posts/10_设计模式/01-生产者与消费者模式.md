...
```
#### → 输出结果截图
![Java生产者与消费者实现](https://img-blog.csdnimg.cn/20200312202830863.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)
...
```
#### → 输出结果截图
![Java生产者与消费者实现](https://img-blog.csdnimg.cn/20200312203133173.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)
...
```
#### → 输出结果截图
![Java队列实现生产者与消费者](https://img-blog.csdnimg.cn/20200314212749778.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70)