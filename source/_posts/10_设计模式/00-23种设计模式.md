...
参考资料：[Java 设计模式](http://c.biancheng.net/view/1317.html)

参考资料：[Java 设计模式精讲 Debug 方式 + 内存分析](https://coding.imooc.com/class/270.html)
...
![image-20230617100425801](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617100427.png)
...
优点：在于其向用户屏蔽了对象创建过程，使得用户可以不必关注具体的创建细节
...
![image-20230617100504784](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617100505.png)
...
![image-20230617100527019](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617100527.png)
...
![image-20230617100548158](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617100548.png)
...
优点：在于将复杂的构建过程拆分为多个独立的单元，在保证拓展性的基础上也保证了良好的封装性，使得客户端不必知道产品的具体创建流程。
...
![image-20230617101143671](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101144.png)
...
![image-20230617101202174](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101202.png)
...
![image-20230617101218689](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101220.png)
...
![image-20230617101236386](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101237.png)
...
![image-20230617101252404](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101253.png)
...
![image-20230617101316134](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101316.png)
...
![image-20230617101332027](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101332.png)
...
![image-20230617101345712](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101346.png)
...
![image-20230617101358619](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101359.png)
...
![image-20230617101412879](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101413.png)
...
![image-20230617101426951](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101427.png)
...
![image-20230617101458919](https://jy-imgs.oss-cn-beijing.aliyuncs.com/img/20230617101459.png)
...
给分析对象定义一种语言，并定义该语言的文法表示，然后设计一个解析器来解释语言中的语句，用编译语言的方式来分析应用中的实例。解释器模式的实现比较复杂，在通常的开发也较少使用。
