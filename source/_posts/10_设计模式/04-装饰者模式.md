...
![Java装饰者设计模式](https://img-blog.csdnimg.cn/20200415174244324.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70#pic_center)
...
```
运行结果：
![Java装饰者设计模式](https://img-blog.csdnimg.cn/20200415174844494.png)
### 1.3 装饰者模式 - 优缺
