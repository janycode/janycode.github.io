...
![Java静态代理设计模式](https://img-blog.csdnimg.cn/20200415172523719.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzM2MTg0MDc1,size_16,color_FFFFFF,t_70#pic_center)
...
```
运行结果：
![Java静态代理设计模式](https://img-blog.csdnimg.cn/20200415173458988.png)
### 1.3 静态代理 - 优缺
